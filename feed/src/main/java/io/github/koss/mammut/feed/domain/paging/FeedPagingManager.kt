...
import io.github.koss.paging.PagingMapper
...
object FeedPagingMapper: PagingMapper<LocalStatus, NetworkStatus, Status> {
...
) : PagingManager<LocalStatus, NetworkStatus, Status> by DefaultPagingManager(
        scope,
        pagingRelay,
        localDataSource,
        networkDataSource,
